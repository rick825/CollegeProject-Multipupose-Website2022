const fade=()=>{
   ...
   const backall = document.querySelectorAll('.backg');
   const colorall = document.querySelectorAll('.ccolor');
   const body=document.querySelector('body');
    ...
    darkbtn.addEventListener('click',()=>{
      ...
      backall.forEach(backg => {
  backg.classList.remove('backgl');
});
    colorall.forEach(ccolor => {
  ccolor.classList.remove('ccolorl');
});
    });
    ...
    backall.forEach(backg => {
  backg.classList.add('backgl');
});
     colorall.forEach(ccolor => {
  ccolor.classList.add('ccolorl');
    });
